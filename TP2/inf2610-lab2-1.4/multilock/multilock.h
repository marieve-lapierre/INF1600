...
struct lib_def {
    ...
    main_t main;    // fonction principale de traitement
...
struct experiment {
    ...
    int rank;           // rang du fil d'exécution (0 à nr_thread - 1)
    ...
    unsigned long outer;        // répétition de la boucle externe (nombre de verrouillage/déverouillage)
