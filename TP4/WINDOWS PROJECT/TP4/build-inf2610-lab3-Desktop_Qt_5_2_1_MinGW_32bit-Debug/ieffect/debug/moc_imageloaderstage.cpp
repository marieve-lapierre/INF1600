...
#include "../../../inf2610-lab3-2.6/ieffect/imageloaderstage.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ImageLoaderStage_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 26, 4)
    },
    "ImageLoaderStage\0imagedir\0QDir\0"
};
...
const QMetaObject ImageLoaderStage::staticMetaObject = {
    { &PipelineStage::staticMetaObject, qt_meta_stringdata_ImageLoaderStage.data,
      qt_meta_data_ImageLoaderStage,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ImageLoaderStage.stringdata))
        return static_cast<void*>(const_cast< ImageLoaderStage*>(this));
...
int ImageLoaderStage::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_id < 0)
     ...
     if (_c == QMetaObject::ReadProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QDir*>(_v) = imageDir(); break;
        }
        _id -= 1;
    } else if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: setImageDir(*reinterpret_cast< QDir*>(_v)); break;
        }
        _id -= 1;
