...
#include "../../../inf2610-lab3-2.6/ieffect/effects/brightness.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Brightness_t, stringdata) + ofs \
...
const QMetaObject Brightness::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Brightness.data,
      qt_meta_data_Brightness,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Brightness.stringdata))
