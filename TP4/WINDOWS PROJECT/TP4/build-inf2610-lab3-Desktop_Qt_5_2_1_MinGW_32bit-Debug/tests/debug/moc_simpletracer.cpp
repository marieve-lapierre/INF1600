...
#include "../../../inf2610-lab3-2.6/ieffect/simpletracer.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SimpleTracer_t, stringdata) + ofs \
...
const QMetaObject SimpleTracer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SimpleTracer.data,
      qt_meta_data_SimpleTracer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SimpleTracer.stringdata))
